...
const { FiShoppingCart, FiHeart, FiStar, FiTrendingUp } = FiIcons;

const ProductRecommendations = ({ currentProductId, title = "You Might Also Like" }) => {
  const { addToCart } = useCart();

  // Mock recommendations data - in a real app, this would be fetched based on the current product
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Discover more premium organic fruits that complement your selection perfectly.
          </p>
        </motion.div>
